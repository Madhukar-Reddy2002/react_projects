...
export default function ABTestAnalyzer() {
  ...
  <div className="mb-8">
    <div className="backdrop-blur-md bg-white/70 rounded-2xl shadow-xl p-6 md:p-8 mb-6">
      <h2 className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600 mb-6">
                  ...
                  <td colSpan="7" className="px-6 py-4">
                    <div className="bg-blue-50/60 p-4 rounded-lg backdrop-blur-sm shadow-inner">
                      <h4 className="text-sm font-semibold text-blue-600 mb-2">
                        Required Conversions to Achieve Significance:
                      </h4>
